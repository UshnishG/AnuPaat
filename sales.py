...
def visualize_data(df):
    ...
    Kindly keep it  10 points only pointwise so that user can read it properly. Also specifically mention the  percentage of discounts we can give with min profit on specific items.
     """
    try:
